...
%-------------------------------------------------------------------------%
% Function "pso_eval" returns the desired anonymous function handle and a %
% suitable parameters for its plotting.                                   %
%                                                                         %
%   Input parameters:                                                     %
%       * n_fun:        Number of the selected function.                  %
%                                                                         %
%   Output variables:                                                     %
%       * z:            Anonymous function dependent of @(x,y).           %
%       * xy_lim:       Recommended axis limits.                          %
%       * n:            Recommended number of lines for visualization.    %
%-------------------------------------------------------------------------%

...
% PSO_CUSTOMGUI MATLAB code for pso_customGUI.fig
%      PSO_CUSTOMGUI, by itself, creates a new PSO_CUSTOMGUI or raises the existing
%      singleton*.
%
%      H = PSO_CUSTOMGUI returns the handle to a new PSO_CUSTOMGUI or the handle to
%      the existing singleton*.
%
%      PSO_CUSTOMGUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in PSO_CUSTOMGUI.M with the given input arguments.
%
%      PSO_CUSTOMGUI('Property','Value',...) creates a new PSO_CUSTOMGUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before pso_customGUI_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to pso_customGUI_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help pso_customGUI

% Last Modified by GUIDE v2.5 29-Jan-2016 17:49:52

...
params.gamma = 50; % Spread factor for SBX Crossover Operator
params.mu = 1; % = 1/nVar  % Mutation probability
params.sigma = 10;   % Distribution index for Polynomial Mutation Operator

params.R = 500;  % Static Penalty Parameter

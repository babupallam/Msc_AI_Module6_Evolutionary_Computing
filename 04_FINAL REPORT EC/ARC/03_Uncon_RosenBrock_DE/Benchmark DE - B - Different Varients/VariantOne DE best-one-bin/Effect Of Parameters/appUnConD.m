...
%Optimised solutions
% beta -- 0.25 to 1.25 --- 1
%nPop 10 and MaxIt = 200 --- 3
% pc = 1  -- 5
%
params.MaxIt = 1000;       % Maximum Number of Iterations
params.nPop = 300;          % Population Size
params.beta_min = 0.25;     % Lower Bound of Scaling Factor (0)
params.beta_max = 1.25;     % Upper Bound of Scaling Factor (2)
params.pCR = 0.6;          % Crossover Probability
